/*
THIS IS AN EXAMPLE STRIPE KEY YOU SHOULD REALLY BE USING YOUR OWN STRIPE API KEY 

Go to https://dashboard.stripe.com/

On the left hand side should say API keys

unless the website changes ;/ look for api keys 
*/

const EXAMPLE_STRIPE_PUBLIC_KEY =
